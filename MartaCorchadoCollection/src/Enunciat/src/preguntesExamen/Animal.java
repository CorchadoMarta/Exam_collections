...
public class Animal {
	...
	public String toString() {
		return this.getCodi() + " " + this.getBreed() + " " + this.getPotes() + " " + this.valorMercat();
	}
	...
	public int compareTo(Object obj) {
		...
		// Save valorMercat in a variable
		int valorA = (int) this.valorMercat();
		int valorB = (int) that.valorMercat();
